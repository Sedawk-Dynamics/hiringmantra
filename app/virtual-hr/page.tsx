              ...
              <div>
                ...
                <div className="space-y-2 text-gray-400">
                  ...
                  <p>
                    ...
                    management meetings (virtually), learns your company culture, and operates as an official member of
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-400">
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                    <span>
                      <strong className="text-white">Data Analytics:</strong> Providing you with clean, customized data
                      reports on turnover, hiring metrics, and compliance status
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <div className="space-y-6">
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    The cost of one Individual V-HR subscription is typically 30% to 70% less than the total loaded cost
                    (salary + benefits + taxes + software) of a permanent full-time HR manager
                  </p>
                </div>
              </div>
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    You pay a fixed monthly retainer for senior expertise, eliminating the surprise costs of hiring and
                    training
                  </p>
                </div>
              </div>
